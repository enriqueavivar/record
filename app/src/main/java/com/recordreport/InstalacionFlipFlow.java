...
public class InstalacionFlipFlow extends AppCompatActivity {
    String nombre = "";
    String apellidos = "";
    String dni = "";
    String tlf = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_crear_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(checkFormValid()){
                    Toast.makeText(InstalacionFlipFlow.this, "Archivo creado correctamente", Toast.LENGTH_SHORT).show();
                    createFile();
                }
                else{
                    Toast.makeText(InstalacionFlipFlow.this, "Rellena todos los datos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private boolean saveExcelFile(Context context, String fileName) {
        ...
        //New Sheet
        Sheet sheet1 = null;
        sheet1 = wb.createSheet("Instalación Flip Flow");
        ...
        String dir = getApplicationContext().getExternalFilesDir(null)+ "/InstalacionFlipFlow/";
    ...
    private void createFile(){
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            if (Build.VERSION.SDK_INT >= 23) {
                if (checkPermission()) {
                    saveExcelFile(InstalacionFlipFlow.this, nombre+"_"+apellidos+"_"+System.currentTimeMillis()+".xls");
                } else {
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(InstalacionFlipFlow.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(InstalacionFlipFlow.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            Toast.makeText(InstalacionFlipFlow.this, "Write External Storage permission allows us to create files. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
        } else {
            ActivityCompat.requestPermissions(InstalacionFlipFlow.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_REQUEST_CODE);
        }
    }
